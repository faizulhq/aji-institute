      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
          {KONSULTASI_LAYANAN.map((item) => (
            <div key={item.title}
              className="flex items-center gap-4 p-5 bg-gray-50 hover:bg-blue-50 border border-gray-100 hover:border-[#2348A8]/20 rounded-2xl transition-all cursor-default">
              <div className="w-10 h-10 bg-[#EBF4FF] rounded-xl flex items-center justify-center shrink-0">
                <item.icon className="w-5 h-5 text-[#2348A8]" />
              </div>
        ...
        <div className="text-center">
          <Link href="/konsultasi" className="inline-flex items-center gap-2 text-[#2348A8] font-semibold hover:underline">
