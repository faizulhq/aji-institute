...
const SLIDES = [
  ...
  },
  {
    ...
    headline: '5 Program\nAji Institute',
    subtext: 'AjiStat, AjiBiz, AjiComm, AjiAI, AjiLingua — satu platform untuk semua kebutuhan pengembangan kompetensi profesional Anda.',
    ...
    chips: ['AjiStat', 'AjiBiz', 'AjiComm', 'AjiAI', 'AjiLingua'],
