  ...
  if (!isAuthenticated()) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center px-4">
        ...
        <Link href="/login" className="bg-[#1B3A8C] text-white px-6 py-3 rounded-xl font-semibold">Masuk</Link>
      </div>
    );
  }
    ...
    <div className="bg-gray-50 min-h-screen py-10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-xl bg-[#1B3A8C] flex items-center justify-center text-white font-bold">
            {user?.avatar}
          </div>
          <div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center shadow-sm">
            ...
            <Link href="/bootcamp" className="bg-[#1B3A8C] text-white font-semibold px-6 py-3 rounded-xl hover:bg-[#2348A8] transition-colors">
              Jelajahi Program
            </Link>
          </div>
        ) : (
                ...
                <div key={order.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                  ...
                  <div className="px-6 py-4">
                    ...
                    <div className="flex justify-between items-center pt-3 mt-2 border-t border-gray-100">
                      ...
                      <span className="font-bold text-[#2348A8]">{formatPrice(order.total_price)}</span>
                    </div>
