...
export default function InHouseTrainingPage() {
  return (
    <>
      {/* HERO */}
      <div className="bg-gradient-to-br from-[#162058] via-[#1B3A8C] to-[#2348A8] py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-10"></div>
        <div className="absolute right-0 top-0 translate-x-1/3 -translate-y-1/3 w-96 h-96 bg-[#4A72D4] rounded-full blur-[120px] opacity-20 hidden lg:block"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex justify-center">
            <a href={WA_LINK('Halo Tim Aji Institute, saya mewakili instansi saya dan ingin berdiskusi mengenai program In-House Training / Kerja Sama Institusional...')}
              ...
              className="inline-flex items-center gap-2 bg-[#F0A500] hover:bg-[#C8870A] text-[#162058] font-black px-8 py-4 rounded-2xl text-lg transition-transform hover:scale-105 shadow-xl">
