  ...
  return (
    <>
      ...
      <div className="min-h-[70vh] flex items-center justify-center relative overflow-hidden"
        style={{ background: `linear-gradient(135deg, #162058 0%, #1B3A8C 60%, ${brand.color}33 100%)` }}>
            ...
            <div className="bg-white/8 border border-white/15 rounded-2xl p-6 text-left">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="bg-[#F0A500] hover:bg-[#C8870A] text-[#162058] font-bold px-5 py-3 rounded-xl text-sm transition-colors"
                >
                  Daftar
                </button>
              </div>
